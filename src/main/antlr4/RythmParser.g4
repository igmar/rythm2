...
outputExpression
    : AT OE_START OE_DOT OE_IDENTIFIER OE_END
    | AT OE_START OE_DOT OE_IDENTIFIER OE_PARENTHESIS_OPEN oeMethodArguments* OE_PARENTHESIS_CLOSE OE_END
    | AT COE_START IDENTIFIER DOT IDENTIFIER PARENTHESIS_OPEN PARENTHESIS_CLOSE COE_END
    ;
